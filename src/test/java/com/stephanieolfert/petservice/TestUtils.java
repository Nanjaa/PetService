...
public class TestUtils {
    ...
    public static Pet invalidType() {
        return new Pet("kitty", 8, 1, Pet.SEX_M, "The cutest cat ever!", "stephanie.r.olfert@gmail.com", "/test.png");
    }
    ...
    public static Pet invalidDescription() {
        return new Pet("kitty", Pet.TYPE_CAT, 1, Pet.SEX_M, null, "stephanie.r.olfert@gmail.com", "/test.png");
    }

    public static Pet invalidOwner_email() {
        return new Pet("kitty", Pet.TYPE_CAT, 1, Pet.SEX_M, "The cutest cat ever!", "stephanie.r.olfert@", "/test.png");
    }
